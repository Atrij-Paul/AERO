...
int sdata6 = 0; // sensor6 data
int sdata7 = 0; // sensor7 data
int sdata8 = 0; // sensor8 data
...
void loop()
{
    ...
    sdata6 = analogRead(sensor6);
    sdata7 = analogRead(sensor7);
    sdata8 = analogRead(sensor8);
   cdata = cdata + sdata1+","+sdata2+","+sdata3+","+sdata4+","+sdata5+","+sdata6+","+sdata7+","+sdata8; // comma will be used a delimeter
